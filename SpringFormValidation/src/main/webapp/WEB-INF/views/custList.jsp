...
<script type="text/javascript" src="<c:url value="/resources/functionsC.js"/>"></script>
...
<body>
	...
	<div id="cos">
		...
		<table class="table table-bordered" class="table">
			...
			<c:forEach items="${listingC}" var="listingC">
				<tr>
					<td><input type="checkbox" value="${listingC.id}" name="checkbox" onclick="showblocked()"></td>
					<td>${listingC.name}</td>
					<td>${listingC.email}</td>
					<td>${listingC.age}</td>
					<td>${listingC.gender}</td>
					<td><fmt:formatDate value="${listingC.birthday}" type="date" /></td>
					<td>${listingC.phone}</td>
					<td>${listingC.user}</td>
					<td>${listingC.password}</td>
					</tr>
			</c:forEach>
		</table>
		</div>
		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            ...
		            <div class="modal-body">
		                <p>Delete <span id="modalCustomersNumber"></span> providers?</p>
		            </div>
