	...
	<div id="cos">
		...
		<div id="personalInfo">
			<h3 class="panel-tittle">
				...
				<a href="<c:url value="provider-editinfo"/>"  class="panel-right btn bnt-default glyphicon glyphicon-edit" ></a>
			</h3> 
		</div>
		...
		<table class="table table-bordered">
			...
			<tr>
				<th>Comment</th>
				<td>${currentProvider.comentario}</td>
			</tr>
			<tr>
				<th>User</th>
				<td>${currentProvider.user}</td>
			</tr>
		</table>
	</div>
