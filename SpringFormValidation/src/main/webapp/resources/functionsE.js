...
$(document).ready(function() 
	    { 
	        ...
	        $(".trashbut").click(function(){
	     	   ...
	     	   $("#modalEmployeesNumber").html(cont);
	         $("#myModal").modal('show');
	     });
	    }); 
...
function showblocked() {
	checkboxes = document.getElementsByName("checkbox");
	trash = document.getElementById("deleteEmployee");
	modify = document.getElementById("modifyEmployee");
	var cont = 0;
	for (var i = 0; i < checkboxes.length; i++) {
		var checkbox = checkboxes[i];
		if(checkbox.checked) {
...
function check(v)
{
    ...
    if (v==1){
    	document.form.employees.value=selected;
    	document.form.submit();
    }
    else if (v==2){
    	document.formM.employee.value=selected;
